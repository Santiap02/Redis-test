package co.com.study.jpa.helper;

import co.com.study.jpa.RolDataRepository;
import co.com.study.jpa.RolDataAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private RolDataRepository repository;

    @Mock
    private ObjectMapper objectMapper;

    private RolDataAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new RolDataAdapter(repository, objectMapper);
    }
